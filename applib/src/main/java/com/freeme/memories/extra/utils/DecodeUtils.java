...
package com.freeme.memories.extra.utils;
...
import com.freeme.memories.extra.bitmappool.AppBitmapPool;
...
public class DecodeUtils {
    ...
    public static Bitmap decodeThumbnail(
        ...
        try {
            ...
            AppUtil.closeSilently(fis);
        }
    }

    public static Bitmap decodeThumbnail(
            ThreadPool.JobContext jc, FileDescriptor fd, Options options, int targetSize,
            int type) {
        if (options == null) {
            options = new Options();
        }
        ...
        float scale = (float) targetSize / (type == Global.TYPE_MICROTHUMBNAIL
    ...
    public static BitmapRegionDecoder createBitmapRegionDecoder(
        ...
        try {
            ...
            LogUtil.e("requestCreateBitmapRegionDecoder: " + t);
            return null;
        }
    }
    ...
    public static Bitmap decodeUsingPool(ThreadPool.JobContext jc, byte[] data, int offset,
        ...
        try {
            ...
            if (options.inBitmap != null && options.inBitmap != bitmap) {
                AppBitmapPool.getInstance().put(options.inBitmap);
            ...
            LogUtil.i("decode fail with a given bitmap, try decode to a new bitmap");
            AppBitmapPool.getInstance().put(options.inBitmap);
            options.inBitmap = null;
    ...
    private static Bitmap findCachedBitmap(ThreadPool.JobContext jc, byte[] data,
        ...
        return AppBitmapPool.getInstance().get(options.outWidth, options.outHeight);
    }
