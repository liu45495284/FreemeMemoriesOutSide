...
import com.freeme.memories.extra.bitmappool.BlobCache.LookupRequest;
import com.freeme.memories.extra.bitmappool.BytesBufferPool.BytesBuffer;
import com.freeme.memories.utils.AppUtil;
import com.freeme.memories.extra.utils.Utils;
...
public class ImageCacheService {
    ...
    public boolean getImageData(Path path, long timeModified, int type, BytesBuffer buffer) {
        ...
        try {
            BlobCache.LookupRequest request = new LookupRequest();
    ...
    private static byte[] makeKey(Path path, long timeModified, int type) {
        return AppUtil.getBytes(path.toString() + "+" + timeModified + "+" + type);
    }
