...
package com.freeme.memories.extra.bitmappool;
...
import com.freeme.memories.extra.entity.MediaObject;
import com.freeme.memories.extra.bitmappool.BytesBufferPool.BytesBuffer;
import com.freeme.memories.pool.ThreadPool.Job;
import com.freeme.memories.pool.ThreadPool.JobContext;
import com.freeme.memories.extra.utils.BitmapUtils;
import com.freeme.memories.extra.utils.DecodeUtils;

public abstract class ImageCacheRequest implements Job<Bitmap> {
    private static final String TAG = "ImageCacheRequest";

    protected IMemoriesApp mApplication;
    private Path mPath;
    private   int        mType;
    private   int        mTargetSize;
    private   long       mTimeModified;

    public ImageCacheRequest(IMemoriesApp application,
    ...
    public Bitmap run(JobContext jc) {
        ...
        BytesBuffer buffer = MediaObject.getBytesBufferPool().get();
        try {
            ...
            if (found) {
                ...
                Bitmap bitmap;
                if (mType == Global.TYPE_MICROTHUMBNAIL) {
            ...
            MediaObject.getBytesBufferPool().recycle(buffer);
        }
    ...
    private String debugTag() {
        return mPath + "," + mTimeModified + "," +
                ((mType == Global.TYPE_THUMBNAIL) ? "THUMB" :
                        (mType == Global.TYPE_MICROTHUMBNAIL) ? "MICROTHUMB" : "?");
    }
