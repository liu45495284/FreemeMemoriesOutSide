...
public class RecyclerViewHeader extends RelativeLayout {
     ...
     * Be sure that <code>setLayoutManager(...)</code> has been called for
     * <code>RecyclerView</code> before calling this method.
     *
     * @param recycler <code>RecyclerView</code> to attach <code>RecyclerViewHeader</code> to.
     */
    public final void attachTo(
            @NonNull
    ...
    private static class RecyclerViewDelegate {
        ...
        private RecyclerViewDelegate(final
        @NonNull
        RecyclerView recyclerView) {
            this.recyclerView = recyclerView;
        }

        public static RecyclerViewDelegate with(
                @NonNull
                RecyclerView recyclerView) {
        ...
        public final int getScrollOffset(boolean isVertical) {
            return isVertical ? recyclerView.computeVerticalScrollOffset() : recyclerView
        ...
        public final boolean hasItems() {
            return recyclerView.getAdapter() != null && recyclerView.getAdapter().getItemCount()
                    != 0;
        }
        ...
        public final void setOnChildAttachListener(
