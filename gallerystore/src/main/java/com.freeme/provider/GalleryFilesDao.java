...
public class GalleryFilesDao extends AbstractDao<GalleryFiles, Long> {
    ...
    public GalleryFiles readEntity(Cursor cursor, int offset) {
        GalleryFiles entity = new GalleryFiles( //
                ...
                cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27), // country
                cursor.isNull(offset + 28) ? null : cursor.getString(offset + 28) // city
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, GalleryFiles entity, int offset) {
        ...
        entity.setCountry(cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27));
        entity.setCity(cursor.isNull(offset + 28) ? null : cursor.getString(offset + 28));
    }
    ...
    protected void bindValues(SQLiteStatement stmt, GalleryFiles entity) {
        ...
        if (country != null) {
            stmt.bindString(28, country);
        }

        String city = entity.getCity();
        if (city != null) {
            stmt.bindString(29, city);
        }
    }
    ...
    public static class Properties {
        ...
        public final static Property Country             = new Property(27, String.class, "country", false, "country");
        public final static Property City             = new Property(28, String.class, "city", false, "city");
    }
